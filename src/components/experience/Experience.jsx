  ...
  processamento digital de imagens </h4>
      ...
      <div className="right">
        ...
        <div className="itemDetails">
          ...
          <a href="https://www.udemy.com/certificate/UC-a69bdffc-f4c8-4ba7-9b01-f879d20158ac/" target="_blank"> <h4> Ver Crendencial </h4> </a>
        </div>
        <div className="itemDetails">
          ...
          <a href="https://www.udemy.com/certificate/UC-e57fd0b3-a9b6-4dfd-9199-357794b1e4e3/" target="_blank"> <h4> Ver Crendencial </h4> </a>
        </div>
      </div>
    </div>
  )
