...
export default function Contact() {
  ...
  processamento digital de imagens </h4>
      ...
      <div className="right">
        ...
        <div className="itemDetails">
          <h3> API Restful Javascript com Node.js </h3>
        ...
        <div className="itemDetails">
          <h3> JavaScript e TypeScript do básico ao avançado </h3>
          <h4> Duração: 145.5 horas no total </h4>
          <h4> Instrutor: Luiz Otávio Miranda </h4>
          <a href="https://www.udemy.com/certificate/UC-311254e5-3b3b-4f71-9d27-9517fe1330fa/" target="_blank" rel="noreferrer"> <h4> Ver Crendencial </h4> </a>
        </div>
      </div>
    </div>
  )
